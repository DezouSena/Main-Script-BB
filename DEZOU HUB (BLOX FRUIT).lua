...
wait(5)
LoadedUiHub = false
local b = syn and syn.request or identifyexecutor() == "Fluxus","Delta" and request or http_request or requests
local d =
    b(
    {
        Url = ""
...
local A =
    z:MakeWindow(
    {
        Name = "Blox Fruit (DEZOU HUB)",
        IntroEnabled = false,
        IntroText = "WELCOME DEZOU HUB",
